...
export const createTemplateSchema = z.object({
    ...
    record_type_id: z.string().uuid({ required_error: "Record type is required" }),
...
export const createMedicalRecordSchema = z.object({
    patient_id: z.string().uuid({ required_error: "Patient ID is required" }),
    appointment_id: z.string().uuid().optional(),
    template_id: z.string().uuid({ required_error: "Template ID is required" }),
    record_type_id: z.string().uuid({ required_error: "Record type ID is required" }),
